...
(() => {
  ...
  const i18n = {
    zh: {
      ...
      "work.title": "手头正在维护的",
      "work.sub": "活的,不是 PPT。",
      "work.1.desc": "一条命令把静态站或 Node 应用部到你的 VPS — Cloudflare DNS + nginx + Let's Encrypt 全链路自动化。带 rollback 和 --dry-run。",
      "work.2.desc": "一键初始化 Ubuntu / Debian VPS,为中国大陆 / 香港 VPS 做过针对性调优。4 种 profile,10+ 幂等模块,SSH 加固带防锁死。含 postgres / mysql 模块。",
      "work.3.desc": "面向中国 / 香港运维的 Cloudflare CLI。核心是 Flexible-SSL 死循环诊断 + HSTS preload / CF 525-526 / CN-ISP RST 检测。dns export / diff / bulk 凑齐 GitOps。",
      "work.4.desc": "严审型 Claude skill:模拟多专家评审团,在作品提交前把致命问题先挑出来。v1.1.1 已发布。",
      "work.5.desc": "把每次对话变成英语练习。答案照常给,顺手纠错和教一句新表达。支持 10 种语言 README。",
      "work.6.desc": "天智工坊服务目录:报价、流程、FAQ、精选作品。GitHub Pages 部署。",
      "work.7.desc": "极简 Cloudflare Pages 静态站起步模板,零构建、零依赖。",
    ...
    en: {
      ...
      "work.1.desc": "One command to ship a static or Node site to your VPS — Cloudflare DNS + nginx + Let's Encrypt wired end-to-end. With rollback and --dry-run.",
      "work.2.desc": "One-command bootstrap for a fresh Ubuntu / Debian VPS, tuned for China-mainland / HK scenarios. Four profiles, 10+ idempotent modules, SSH hardening with anti-lockout. Includes postgres / mysql modules.",
      "work.3.desc": "A Cloudflare CLI for China / HK operators. Lead feature: Flexible-SSL redirect-loop diagnostic, plus HSTS preload / CF 525-526 / CN-ISP RST detection. dns export / diff / bulk close the GitOps loop.",
      "work.4.desc": "A ruthless review Claude skill — simulated expert panel catches fatal problems before you ship. v1.1.1.",
      "work.5.desc": "Turns every Claude conversation into English practice — answers first, then corrects and teaches. READMEs in 10 languages.",
      "work.6.desc": "Tianmind service catalog: pricing, process, FAQ, featured work. Deployed on GitHub Pages.",
      "work.7.desc": "Minimal Cloudflare Pages static starter. Zero build, zero dependencies.",
